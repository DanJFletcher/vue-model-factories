...
You can pass a number as the second argument to the `factory()` function. By default this value will be `1`, and the factory will return a single object. If you pass any number greater than `1` you'll will receive an array of the created objects instead.
...
Of course you likely don't want to create a list of the same object. You can either use a library like `faker` directly in your `FactoryModel` or you optionally, you can override the defaults.
